...
CREATE TABLE `colecciones` (
  ...
  `titulo` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_bin DEFAULT NULL,
  `descripcion` text CHARACTER SET utf8mb3 COLLATE utf8mb3_bin,
  `precio` decimal(10,2) DEFAULT NULL,
  `imagen_principal` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_bin DEFAULT NULL,
  `imagen_secundaria` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_bin DEFAULT NULL,
...
CREATE TABLE `usuarios` (
  ...
  `apellido` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_bin NOT NULL,
  `dni` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_bin NOT NULL,
  `provincia` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_bin NOT NULL,
  `email` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_bin NOT NULL,
  `password` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_bin NOT NULL,
  `rating` int NOT NULL,
  `comentarios` text CHARACTER SET utf8mb3 COLLATE utf8mb3_bin NOT NULL,
...
INSERT INTO `usuarios` VALUES (1,'Juan Agustín','Pérez','12345678','Buenos Aires','juan.perez@example.com','perez12345*',5,'Me gusta esta tienda',1),(2,'Julio Ceferino','Acuña','17581419','Salta','saltagaceta@yahoo.com.ar','20205701',2,'Fue la mejor compra',1);
...
CREATE TABLE `ventas` (
  ...
  `colecciones_id` int DEFAULT NULL,
  `fecha` date NOT NULL,
  `cantidad` int NOT NULL,
  `total` decimal(10,2) NOT NULL,
  PRIMARY KEY (`id_ventas`),
  KEY `usuario_id` (`usuario_id`),
  KEY `ventas_ibfk_2` (`producto_id`),
  KEY `ventas_ibfk_3` (`colecciones_id`),
  CONSTRAINT `ventas_ibfk_1` FOREIGN KEY (`usuario_id`) REFERENCES `usuarios` (`id_usuarios`),
  CONSTRAINT `ventas_ibfk_2` FOREIGN KEY (`producto_id`) REFERENCES `productos` (`id_productos`),
  CONSTRAINT `ventas_ibfk_3` FOREIGN KEY (`colecciones_id`) REFERENCES `colecciones` (`id_colecciones`)
...
INSERT INTO `ventas` VALUES (2,1,1,NULL,'2024-06-17',1,890.00),(3,2,7,NULL,'2024-06-16',1,179.00),(4,2,NULL,7,'2024-06-16',1,270.00);
...
-- Dump completed on 2024-06-21 21:44:49
